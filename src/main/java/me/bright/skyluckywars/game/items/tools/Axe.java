...
public class Axe extends LItem implements Enchantable {

    private EnchantmentSet enchSet;

    public Axe() {
        super(new Pair<>(Material.IRON_AXE,100),new Pair<>(Material.DIAMOND_AXE,50),
                new Pair<>(Material.NETHERITE_AXE,15));
        enchSet =  getDefaultEnchSet(DropSet.DropCategory.TOOLS)
