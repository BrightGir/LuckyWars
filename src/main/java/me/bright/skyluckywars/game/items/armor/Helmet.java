...
public class Helmet extends LItem implements Enchantable {

    private EnchantmentSet enchSet;

    public Helmet() {
        super(new Pair<>(Material.IRON_HELMET,100),new Pair<>(Material.DIAMOND_HELMET,40),
                new Pair<>(Material.NETHERITE_HELMET,10));
